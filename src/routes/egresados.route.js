...
// Aqui empieza el dashboard1
router.get('/data/dashboard1', async (req, res) => {
...
// Aqui termina el dashboard1

// Aqui empieza el dashboard2
...
// Aqui termina el dashboard2

// Aqui empieza el dashboard3
router.get('/data/dashboard3', async (req, res) => {
...
// Aqui termina el dashboard3

// Aqui empieza el dashboard4
router.get('/data/dashboard4', async (req, res) => {
...
// Aqui termina el dashboard4

// Aqui empieza el dashboard5
router.get('/data/dashboard5', async (req, res) => {
